    ...
    <div class="wrapper">
        ...
        <section id="spark" class="ptb ptb-sm-80 text-center">
            <div class="container">
              ...
              <!--   <p class="max-width-700 lead">
                Who what why where
                Smart, professional, impress your audience, simple, detail-oriented, agenda board, conference programmes, best for exhibitions and trade shows.
                </p> -->
            </div>
            
            <div class="container">
                <div class="row" style="text-align:left;">
                    <ul class="col-md-8 col-sm-8 col-xs-11 content-list" style="list-style:none;padding:0;margin: 0 auto;float:none;">
        ...
        <section id="quotation" class="dark-bg ptb-60">
            <div class="container">
                <div class="col-md-8 col-sm-8">
                    <h4 class="action-box-title">Look no further, we've got your Digital Signage needs covered.</h4>
                </div>
                    <div class="col-md-4 col-sm-4">
                        <a class="btn btn-md btn-white float-right float-none-xs">Get Quotation</a>
            ...
            <div class="container">
                ...
                <div class="row footer-info mb-60">
                    ...
                    <div class="col-md-3 col-sm-12 col-xs-12">
                        ...
                        <ul class="link-small">
                            <li><a href="mailto:info@omniphics.com"><span class="text-bold">Email :</span> info@omniphics.com</a></li>
                            <li><a href="tel:+60122989995"><span class="text-bold">Call :</span> +60122989995</a></li>
                        </ul>
                    </div>
                </div>
                <!-- End Footer Info -->
